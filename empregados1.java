...
abstract class Empregado {
	...
	public Empregado(String nome, int idade, String email, String telefone) {
		this.nome = nome;
		this.idade = idade;
		this.email = email;
...
class Celetista extends Empregado {
	...
	public Celetista(String nome, int idade, String email, String telefone, String nomeEmpresa) {
...
class Terceirizado extends Empregado {
	...
	public Terceirizado(String nome, int idade, String email, String telefone, String localizacaoAtual) {
		super(nome, idade, email, telefone);
		...
		while (true) {
			...
			switch (escolha) {
			   case 1:
				   ...
				   Celetista celetista = new Celetista(nomeCeletista, idadeCeletista, emailCeletista, telefoneCeletista, nomeEmpresa);
			   ...
			   case 2:
				   ...
				   Terceirizado terceirizado = new Terceirizado(nomeTerceirizado, idadeTerceirizado, emailTerceirizado, telefoneTerceirizado, localizacaoAtual);
